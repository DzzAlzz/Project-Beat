    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private void CreateLevelMouseButton(Transform parent, string name, Vector2 pos, Vector2 size, System.Action clickAction, string visualLabel = null)
        {
            ...
            if (!string.IsNullOrEmpty(visualLabel))
            {
                ...
                label = CreateTmp(go.transform, name + "_Label", labelText, Vector2.zero, size, isArrow ? 36f : 16f, isArrow ? new Color(0.88f, 1f, 1f, 0.95f) : new Color(0.78f, 1f, 1f, 0.55f), 1, FontStyles.Bold, isArrow ? 0f : 2f);
                if (label != null)
