...
namespace ProjectBeat.Runtime
{
    ...
    public class Conductor : MonoBehaviour
    {
        ...
        public float CalibrationOffset { get; private set; } = 0f;
        ...
        public void Initialize(float bpm, float offset, AudioClip clip)
        {
            ...
            SongOffset = offset;
            CalibrationOffset = PlayerPrefs.GetFloat("ProjectBeat_TimingOffset", 0f);
        ...
        public void SetCalibrationOffset(float offsetSeconds)
        {
            CalibrationOffset = Mathf.Clamp(offsetSeconds, -0.30f, 0.30f);
            PlayerPrefs.SetFloat("ProjectBeat_TimingOffset", CalibrationOffset);
            PlayerPrefs.Save();
        }
        ...
        public void SetPaused(bool pause)
        {
            ...
            else if (!pause && isPaused)
            {
                ...
                songDspStartTime = AudioSettings.dspTime - pausedSongPosition - SongOffset - CalibrationOffset;
                audioSource.UnPause();
            }
        }
        ...
        private void Update()
        {
            ...
            SongPosition = (float)(dsp - songDspStartTime) - SongOffset - CalibrationOffset;
