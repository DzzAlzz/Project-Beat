...
namespace ProjectBeat.Editor
{
    ...
    public static class DemoSceneBuilder
    {
        ...
        public static void BuildDemoScene()
        {
            ...
            {
                ("acelerada",                "ACELERADA",                    false, "ACELERADA",         "Funk BR",    BackgroundTheme.NeonOrange,
                    new[]{ new Color(1.00f,0.55f,0.05f), new Color(1.00f,0.35f,0.05f), new Color(1.00f,0.80f,0.10f), new Color(1.00f,0.30f,0.00f) }),
                ("mente_ma",                 "Nakama__Mc_Staff_-_MENTE_MA",  false, "MENTE MA",          "Nakama",     BackgroundTheme.NeonBlue,
                    new[]{ new Color(0.20f,0.60f,1.00f), new Color(0.10f,0.40f,0.90f), new Color(0.40f,0.80f,1.00f), new Color(0.10f,0.30f,0.80f) }),
                ("montagem_vozes_talentinho","MONTAGEM_VOZES_TALENTINHO",    false, "MONTAGEM VOZES",    "Talentinho", BackgroundTheme.NeonPink,
                    new[]{ new Color(1.00f,0.25f,0.75f), new Color(0.90f,0.10f,0.60f), new Color(1.00f,0.60f,0.90f), new Color(0.80f,0.10f,0.50f) }),
                ("olha_mensagem",            "OLHA_MENSAGEM",                false, "OLHA MENSAGEM",     "Funk BR",    BackgroundTheme.NeonGreen,
                    new[]{ new Color(0.10f,0.90f,0.30f), new Color(0.05f,0.70f,0.20f), new Color(0.40f,1.00f,0.50f), new Color(0.05f,0.60f,0.15f) }),
                ("ritmo_funk",               "RITMO_FUNK",                   false, "RITMO FUNK",        "Funk BR",    BackgroundTheme.NeonPurple,
                    new[]{ new Color(0.70f,0.20f,1.00f), new Color(0.55f,0.10f,0.90f), new Color(0.85f,0.50f,1.00f), new Color(0.50f,0.10f,0.80f) }),
                ("projectbeat_demo",         "projectbeat_demo",             true,  "PROJECT BEAT DEMO", "PB Team",    BackgroundTheme.NeonPurple,
                    new[]{ new Color(0.35f,0.85f,1.00f), new Color(0.65f,0.50f,1.00f), new Color(1.00f,0.45f,0.85f), new Color(1.00f,0.65f,0.35f) }),
            };
        ...
        private static void CreateUI(Transform parent, out GameplayUI gameplayUI, out PauseMenu pauseMenu, GameController gc)
        {
            ...
            // Song title — top left
            TMP_Text songText     = CreateText(canvasGO.transform, "SongText",      new Vector2( 200, -65),  new Vector2(420, 100), font, 28, TextAlignmentOptions.TopLeft);
            // Score — top right
            TMP_Text scoreText    = CreateText(canvasGO.transform, "ScoreText",     new Vector2(-200, -65),  new Vector2(420, 100), font, 32, TextAlignmentOptions.TopRight);
            // Multiplier badge — top right, below score
            TMP_Text multText     = CreateText(canvasGO.transform, "MultText",      new Vector2(-200, -145), new Vector2(300, 50),  font, 28, TextAlignmentOptions.TopRight);
            ...
            // Accuracy — bottom center
            TMP_Text accText      = CreateText(canvasGO.transform, "AccText",       new Vector2(  0, -310),  new Vector2(300, 50),  font, 28, TextAlignmentOptions.Center);
            // ESC hint
            TMP_Text escHint      = CreateText(canvasGO.transform, "EscHint",       new Vector2(  0, -360),  new Vector2(380, 36),  font, 18, TextAlignmentOptions.Center);
            escHint.text  = "<color=#443322>[ ESC ] Pausa</color>";
