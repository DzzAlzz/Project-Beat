...
namespace ProjectBeat.Runtime
{
    ...
    public class GameplayUI : MonoBehaviour
    {
        ...
        public void ShowResults(ScoreManager sm, BeatmapData beatmap)
        {
            ...
            SetGameplayKeyIndicatorsVisible(false);
            ...
            {
                modernNextLevelText.gameObject.SetActive(hasNextLevel);
                modernNextLevelText.text = hasNextLevel
                    ? "<color=#00F1FF>[ N ]</color> <color=#FFFFFF><b>SIGUIENTE NIVEL</b></color>"
                    : string.Empty;
            }
            if (modernOptionsText != null)
                modernOptionsText.text = "<color=#00F1FF>[ R ] Reiniciar</color>     <color=#FF66D9>[ ESC ] Volver</color>";
            if (modernAccentLine != null) modernAccentLine.color = new Color(rc.r, rc.g, rc.b, 0.9f);
            if (modernResultGlowMagenta != null) modernResultGlowMagenta.color = new Color(1f, 0.10f, 0.80f, 0.12f);
            if (modernResultGlowCyan != null) modernResultGlowCyan.color = new Color(0f, 0.92f, 1f, 0.10f);
        ...
        private void EnsureModernResultsScreen()
        {
            ...
            if (rootImg != null) rootImg.color = new Color(0.010f, 0.000f, 0.045f, 0.74f);
            ...
            CreateResultImage(resultGroup.transform, "PB_Result_DimPurpleWash", Vector2.zero, new Vector2(2600f, 1500f), new Color(0.070f, 0.000f, 0.120f, 0.28f));
            modernResultGlowMagenta = CreateResultImage(resultGroup.transform, "PB_Result_BackGlowMagenta", new Vector2(-220f, 180f), new Vector2(980f, 190f), new Color(1f, 0.10f, 0.80f, 0.12f));
            modernResultGlowCyan = CreateResultImage(resultGroup.transform, "PB_Result_BackGlowCyan", new Vector2(210f, -220f), new Vector2(920f, 160f), new Color(0f, 0.92f, 1f, 0.10f));
            ...
            resultCard.sizeDelta = new Vector2(900f, 650f);
            resultCard.anchoredPosition = Vector2.zero;

            Image cardImg = cardGO.AddComponent<Image>();
            cardImg.color = new Color(0.055f, 0.012f, 0.110f, 0.96f);

            Outline outline = cardGO.AddComponent<Outline>();
            outline.effectColor = new Color(0f, 0.94f, 1f, 0.48f);
            outline.effectDistance = new Vector2(2.3f, -2.3f);

            modernAccentLine = CreateResultImage(resultCard, "AccentLine", new Vector2(0f, 300f), new Vector2(680f, 4f), new Color(1f, 0.12f, 0.82f, 0.95f));
            CreateResultImage(resultCard, "CyanLine", new Vector2(0f, 286f), new Vector2(520f, 3f), new Color(0f, 0.94f, 1f, 0.85f));
            CreateResultImage(resultCard, "BottomLine", new Vector2(0f, -288f), new Vector2(560f, 3f), new Color(1f, 0.12f, 0.82f, 0.80f));
            CreateResultImage(resultCard, "StatsBack", new Vector2(0f, -102f), new Vector2(780f, 118f), new Color(0.035f, 0.000f, 0.090f, 0.54f));

            modernLevelText = CreateResultText(resultCard, "LevelName", new Vector2(0f, 245f), new Vector2(760f, 82f), 34f, TextAlignmentOptions.Center, FontStyles.Bold, 4f);
            modernRankText = CreateResultText(resultCard, "Rank", new Vector2(0f, 105f), new Vector2(430f, 200f), 42f, TextAlignmentOptions.Center, FontStyles.Bold, 2f);

            modernScoreText = CreateResultText(resultCard, "ScoreStat", new Vector2(-275f, -92f), new Vector2(250f, 95f), 26f, TextAlignmentOptions.Center, FontStyles.Bold, 1f);
            modernAccuracyText = CreateResultText(resultCard, "AccuracyStat", new Vector2(0f, -92f), new Vector2(250f, 95f), 26f, TextAlignmentOptions.Center, FontStyles.Bold, 1f);
            modernComboText = CreateResultText(resultCard, "ComboStat", new Vector2(275f, -92f), new Vector2(250f, 95f), 26f, TextAlignmentOptions.Center, FontStyles.Bold, 1f);

            modernHitStatsText = CreateResultText(resultCard, "HitStats", new Vector2(0f, -198f), new Vector2(780f, 60f), 24f, TextAlignmentOptions.Center, FontStyles.Bold, 1f);
            modernNextLevelText = CreateResultText(resultCard, "NextLevelOption", new Vector2(0f, -244f), new Vector2(760f, 36f), 22f, TextAlignmentOptions.Center, FontStyles.Bold, 1f);
            modernOptionsText = CreateResultText(resultCard, "Options", new Vector2(0f, -272f), new Vector2(760f, 34f), 19f, TextAlignmentOptions.Center, FontStyles.Normal, 1f);
        }
