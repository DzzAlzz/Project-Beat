    ...
    public class GameplayUI : MonoBehaviour
    {
        ...
        public void UpdateStats(int score, int combo, float accuracy, int multiplier = 1)
        {
            ...
            if (accuracyText != null)
                accuracyText.text = $"<size=18><color=#FF66D9>PREC</color></size>\n" +
        ...
        private void RepositionGameplayHud()
        {
            ...
            PositionTmp(songText,     new Vector2(1f, 1f), new Vector2(-54f, -56f),  new Vector2(340f, 70f),  TextAlignmentOptions.TopRight);
            PositionTmp(scoreText,    new Vector2(1f, 1f), new Vector2(-54f, -128f), new Vector2(340f, 62f),  TextAlignmentOptions.TopRight);
            PositionTmp(accuracyText, new Vector2(1f, 1f), new Vector2(-54f, -188f), new Vector2(340f, 50f),  TextAlignmentOptions.TopRight);
            ...
            if (pauseHintHudText != null)
            {
                ...
                PositionTmp(pauseHintHudText, new Vector2(1f, 1f), new Vector2(-54f, -224f), new Vector2(340f, 32f), TextAlignmentOptions.TopRight);
            }
        }
        ...
        private void EnsureHudInfoPanel()
        {
            ...
            hudInfoPanel.anchoredPosition = new Vector2(-30f, -34f);
            hudInfoPanel.sizeDelta = new Vector2(385f, 230f);

            Image bg = panelGO.AddComponent<Image>();
            bg.raycastTarget = false;
            bg.color = new Color(0.050f, 0.006f, 0.105f, 0.58f);

            Outline outline = panelGO.AddComponent<Outline>();
            outline.effectColor = new Color(0f, 0.94f, 1f, 0.30f);
            outline.effectDistance = new Vector2(1.8f, -1.8f);

            CreateHudDecorLine(hudInfoPanel, new Vector2(0f, 101f), new Vector2(292f, 3f), new Color(1f, 0.12f, 0.82f, 0.56f));
            CreateHudDecorLine(hudInfoPanel, new Vector2(0f, 91f), new Vector2(214f, 2f), new Color(0f, 0.94f, 1f, 0.46f));
            CreateHudDecorLine(hudInfoPanel, new Vector2(0f, -101f), new Vector2(260f, 2f), new Color(0f, 0.94f, 1f, 0.32f));
        ...
        private void Update()
        {
            ...
            if (scoreText != null)
            {
                ...
                scoreText.text = $"<size=18><color=#00F1FF>PUNTUACIÓN</color></size>\n" +
