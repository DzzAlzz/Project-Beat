...
namespace ProjectBeat.Runtime
{
    ...
    public class ProjectBeatCursorController : MonoBehaviour
    {
        ...
        // Avance 80: cursor visual por UI para builds.
        ...
        private void Awake()
        {
            ...
            // Avance 80: cargar textura real desde Resources para asegurar inclusion en build.
            // Si no existe, se genera una textura por codigo como fallback.
        ...
        private bool EnsureVisualCursorCanvas()
        {
            ...
            visualCursorRect.pivot = new Vector2(0.10f, 0.90f);
            visualCursorRect.sizeDelta = new Vector2(48f, 48f);
        ...
        private Sprite CreateCursorSprite(Texture2D texture)
        {
            ...
            return Sprite.Create(texture, new Rect(0f, 0f, texture.width, texture.height), new Vector2(0.10f, 0.90f), 100f);
        }
        ...
        private void UpdateVisualCursor(bool hover)
        {
            ...
            if (visualCursorCanvasRect != null && RectTransformUtility.ScreenPointToLocalPointInRectangle(visualCursorCanvasRect, Input.mousePosition, null, out localPosition))
                visualCursorRect.anchoredPosition = localPosition;
            else
                visualCursorRect.anchoredPosition = Input.mousePosition;

            float scale = hover ? 1.12f : 1.0f;
            visualCursorRect.localScale = Vector3.Lerp(visualCursorRect.localScale, Vector3.one * scale, Time.unscaledDeltaTime * 16f);
        }
