...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private void RefreshLevelSelectLabels()
        {
            ...
            if (levelNameText != null)
            {
                ...
                levelNameText.text =
                    ...
                    "<size=42><color=#FF8A28><</color></size>  " +
                    "<b><color=#69FFFF>" + level.levelName + "</color></b>" +
                    "  <size=42><color=#FF8A28>></color></size>\n" +
        ...
        private void BuildCommercialLevelSelect()
        {
            ...
            CreateLevelMouseButton(levelSelectGroup.transform, "PB_UI_LevelMouse_Start", new Vector2(0f, -72f), new Vector2(700f, 76f), ConfirmLevelSelect);
