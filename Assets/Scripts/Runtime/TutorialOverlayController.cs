...
namespace ProjectBeat.Runtime
{
    ...
    public class TutorialOverlayController : MonoBehaviour
    {
        ...
        private void BuildUI()
        {
            ...
            if (mobile)
            {
                // Avance 98: tutorial compacto para Android, para que no tape los
                // botones tactiles D/F/J/K ni la pista central.
                prt.anchorMin = new Vector2(0f, 1f);
                prt.anchorMax = new Vector2(0f, 1f);
                prt.pivot = new Vector2(0f, 1f);
                prt.sizeDelta = new Vector2(330f, 305f);
            ...
            CreateDecorLine(panel.transform, mobile ? new Vector2(0f, 130f) : new Vector2(0f, 300f), mobile ? new Vector2(246f, 3f) : new Vector2(286f, 3f), new Color(1f, 0.12f, 0.82f, 0.92f));
            CreateDecorLine(panel.transform, mobile ? new Vector2(0f, 118f) : new Vector2(0f, 286f), mobile ? new Vector2(190f, 2f) : new Vector2(224f, 2f), new Color(0f, 0.94f, 1f, 0.86f));
            CreateDecorLine(panel.transform, mobile ? new Vector2(0f, -132f) : new Vector2(0f, -300f), mobile ? new Vector2(220f, 3f) : new Vector2(254f, 3f), new Color(1f, 0.12f, 0.82f, 0.78f));

            TMP_Text title = CreatePanelText(panel.transform, "Title", mobile ? new Vector2(0f, 94f) : new Vector2(0f, 252f), mobile ? new Vector2(285f, 34f) : new Vector2(304f, 48f), mobile ? 19f : 24f, TextAlignmentOptions.Center, FontStyles.Bold, 4f);
            title.text = mobile ? "<color=#00F1FF>TUTORIAL ANDROID</color>" : "<color=#00F1FF>TUTORIAL</color>";

            CreateKeyCaps(panel.transform);

            TMP_Text text = CreatePanelText(panel.transform, "Body", mobile ? new Vector2(0f, -48f) : new Vector2(0f, -64f), mobile ? new Vector2(280f, 155f) : new Vector2(306f, 420f), mobile ? 12.6f : 14.4f, TextAlignmentOptions.TopLeft, FontStyles.Normal, 0.15f);
            text.text = mobile
                ? "<color=#FF66D9><b>CONTROLES</b></color>\n" +
                  "<color=#EAF4FF>Toca D / F / J / K en pantalla.</color>\n" +
                  "<color=#BFC8E6>Golpea cuando la nota llegue a la barra.</color>\n\n" +
                  "<color=#FFF36B><b>PRECISION</b></color>\n" +
                  "<color=#FFF36B><b>PERFECTO</b></color>: excelente.  " +
                  "<color=#7CFFB2><b>BIEN</b></color>: correcto.\n" +
                  "<color=#FFB25C><b>MAL</b></color>: impreciso.  " +
                  "<color=#FF5A66><b>FALLO</b></color>: perdida.\n\n" +
                  "<color=#00F1FF><b>OBJETIVO</b></color>\n" +
                  "<color=#BFC8E6>Mantén combo y no sueltes las hold notes.</color>"
                : "<color=#FF66D9><b>CONTROLES</b></color>\n" +
        ...
        private void CreateKeyCaps(Transform parent)
        {
            ...
            for (int i = 0; i < labels.Length; i++)
            {
                ...
                rt.anchorMin = rt.anchorMax = new Vector2(0.5f, 0.5f);
                rt.pivot = new Vector2(0.5f, 0.5f);
                rt.anchoredPosition = new Vector2(xs[i], IsAndroidRuntime ? 48f : 200f);
                rt.sizeDelta = IsAndroidRuntime ? new Vector2(48f, 36f) : new Vector2(54f, 42f);
                ...
                grt.sizeDelta = IsAndroidRuntime ? new Vector2(68f, 50f) : new Vector2(78f, 58f);
                ...
                TMP_Text label = CreatePanelText(keyGO.transform, "Label", Vector2.zero, IsAndroidRuntime ? new Vector2(48f, 36f) : new Vector2(54f, 42f), IsAndroidRuntime ? 17f : 20f, TextAlignmentOptions.Center, FontStyles.Bold, 1f);
