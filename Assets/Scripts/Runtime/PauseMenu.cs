...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private System.Collections.IEnumerator ReturnToInitialMenuSafeRoutine()
        {
            ...
            // Avance 42 Safe Navigation + Mouse UI:
            // flujo aislado. No toca Reiniciar, Tutorial, Selector, Configuracion ni Creditos.
            // Solo muestra CARGANDO..., limpia estado basico y fuerza el menu inicial en una
            // escena recargada para evitar que el GameController anterior quede vivo.
            isPaused = false;
            isInLevelSelect = false;
            isInSettings = false;
            isInCredits = false;
            ...
            // Se registra un callback posterior a la carga para forzar la pantalla inicial.
            // Esto evita depender solo del orden interno RuntimeInitializeOnLoadMethod.
            if (!mainMenuSceneLoadPending)
            {
            ...
            // Fallback seguro para editor/dev si el nombre no esta en Build Settings.
