...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private string Bar(float value)
        {
            ...
            string bar = "";
            for (int i = 0; i < 10; i++) bar += i == filled ? "o" : (i < filled ? "=" : "-");
        ...
        private void RefreshSettingsLabels()
        {
            ...
            if (settingsBodyText != null)
            {
                ...
                settingsBodyText.text =
                    s0 + "\n" +
                    "D/F/J/K  Carriles    ESC  Pausa    ENTER  Confirmar\n" +
                    "Flechas o W/S  Navegar    F2/F3/F4  Offset\n\n" +
                    s1 + "\n" +
            ...
            if (settingsHintText != null)
                settingsHintText.text = "<color=#00F1FF>[↑/↓]</color> Navegar   <color=#FFF000>[←/→]</color> Ajustar   <color=#FF6A00>[ESC]</color> Volver";
        }
        ...
        private void BuildCommercialPauseMenu()
        {
            ...
            CreateTmp(pauseGroup.transform, "PB_UI_PauseHint", "<color=#00F1FF>[↑/↓]</color> Navegar     <color=#FFF000>[ENTER]</color> Confirmar     <color=#FF6A00>[ESC]</color> Cerrar", new Vector2(0f, -258f), new Vector2(540f, 28f), 17f, TextNormal, 20, FontStyles.Normal, 1.5f);
            RefreshLabels();
        }
        ...
        private void BuildBasicSettingsPanel()
        {
            ...
            settingsBodyText = CreateTmp(root.transform, "PB_Settings_Body", "", new Vector2(0f, 5f), new Vector2(650f, 310f), 21f, TextNormal, 5, FontStyles.Normal, 1.2f);
            settingsBodyText.alignment = TextAlignmentOptions.Left;
            settingsHintText = CreateTmp(root.transform, "PB_Settings_Hint", "", new Vector2(0f, -230f), new Vector2(660f, 30f), 17f, TextNormal, 6, FontStyles.Normal, 1.5f);
            ApplyBrightness();
            RefreshSettingsLabels();
        }
