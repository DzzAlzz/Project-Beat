...
namespace ProjectBeat.Runtime
{
    ...
    public class LaneInput : MonoBehaviour
    {
        ...
        public bool IsKeyHeld => Input.GetKey(key);
        public bool WasKeyReleasedThisFrame => Input.GetKeyUp(key);
        ...
        private void Update()
        {
            ...
            if (cachedPauseMenu != null && cachedPauseMenu.IsPaused) { SetGlow(Color.clear); return; }
