...
namespace ProjectBeat.Runtime
{
    ...
    /// Options: Resume | Select Level | Restart | Quit
    /// When selecting a level, left/right arrows scroll through levels.
    /// </summary>
    public class PauseMenu : MonoBehaviour
    {
        ...
        private static readonly Color NormalColor = new Color(0.78f, 0.78f, 0.90f, 1f);
        private static readonly Color ActiveColor = new Color(1f, 0.92f, 0.2f, 1f);
        ...
        private void RefreshLabels()
        {
            ...
            for (int i = 0; i < labels.Length; i++)
            {
                ...
                labels[i].fontSize  = active ? 42f               : 34f;
                ...
                if (active)
                    ...
                    labels[i].text =
                        "   <color=#887766>" + OptionNames[i] + "</color>";
            }
        }
        ...
        private void RefreshLevelSelectLabels()
        {
            ...
            if (levelNameText != null)
                levelNameText.text =
                    "<< <b><color=#ffee00>" + level.levelName + "</color></b> >>\n" +
                    "<size=22><color=#aaaaff>(" + (idx + 1) + " / " + total + ")</color></size>";
            ...
            if (levelHintText != null)
                levelHintText.text =
                    "[<] [>] Cambiar nivel     Enter Confirmar     ESC Volver";
        }
