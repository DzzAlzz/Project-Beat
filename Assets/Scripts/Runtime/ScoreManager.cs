...
namespace ProjectBeat.Runtime
{
    ...
    public class ScoreManager : MonoBehaviour
    {
        ...
        {
            // Bonus de Hold Notes: no aumenta el contador total de notas,
            // solo premia mantener correctamente sin alterar la precisión base.
            int bonus = Mathf.RoundToInt(Mathf.Clamp(duration, 0.2f, 4f) * 240f * Multiplier);
            Score += bonus;
            Combo++;
            Multiplier = GetMultiplier(Combo);
        ...
        {
            // Penalización de Hold Notes: corta combo sin sumar una nota extra
            // al total, evitando desordenar las estadísticas del resultado.
            Combo = 0;
            Multiplier = 1;
        }
