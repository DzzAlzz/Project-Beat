...
namespace ProjectBeat.Runtime
{
    ...
    public class GameplayUI : MonoBehaviour
    {
        ...
        private void EnsureModernResultsScreen()
        {
            ...
            resultNextButton = CreateResultButton(resultCard, "ButtonNextLevel", new Vector2(-270f, -246f), new Vector2(230f, 58f), "SIGUIENTE NIVEL", out resultNextButtonLabel, new Color(0.10f, 0.02f, 0.22f, 0.96f), new Color(0f, 0.94f, 1f, 0.80f));
            resultRestartButton = CreateResultButton(resultCard, "ButtonRestart", new Vector2(0f, -246f), new Vector2(210f, 58f), "REINICIAR", out resultRestartButtonLabel, new Color(0.10f, 0.02f, 0.22f, 0.96f), new Color(1f, 0.12f, 0.82f, 0.80f));
            resultBackButton = CreateResultButton(resultCard, "ButtonBack", new Vector2(250f, -246f), new Vector2(190f, 58f), "VOLVER", out resultBackButtonLabel, new Color(0.10f, 0.02f, 0.22f, 0.96f), new Color(1f, 0.55f, 0.16f, 0.80f));
