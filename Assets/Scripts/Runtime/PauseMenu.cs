...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private void HandleSettingsRowClickFallback()
        {
            ...
            // Limites seguros del contenido visible. Incluye margen suficiente para texto izquierdo,
            // centro de la fila y valores del lado derecho.
            if (localPoint.x < -740f || localPoint.x > 720f)
                return;
            ...
            // Sliders se mantienen controlados por sus zonas de arrastre. El respaldo solo activa
            // opciones tipo botón/valor para no interferir con brillo, efectos y volumen.
            switch (option)
            {
                case 2: // Resolucion
        ...
        {
            // Avance 91: cada fila de configuración usa una zona amplia y estable.
            // Esto permite clickear tanto el texto izquierdo como el valor derecho sin depender
            // de un punto pequeño de interacción.
            ...
            AddTrigger(trigger, EventTriggerType.PointerClick, (_) =>
            {
                ...
                selectedSettingsOption = optionIndex;
                if (clickActs)
                    ActivateSettingsMouseOption(optionIndex);
                else
                    RefreshSettingsPanel();
            });
        }
