...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private void BuildSettingsPanel()
        {
            ...
            AddSettingsSliderMouseZone(content, "PB_Settings_Mouse_BrightnessSlider", new Vector2(270f, 154f), new Vector2(520f, 48f), 1);
            ...
            AddSettingsSliderMouseZone(content, "PB_Settings_Mouse_EffectsSlider", new Vector2(270f, -44f), new Vector2(520f, 48f), 4);
            ...
            AddSettingsSliderMouseZone(content, "PB_Settings_Mouse_VolumeSlider", new Vector2(270f, -450f), new Vector2(520f, 48f), 9);
        ...
        private void AddSettingsMouseZone(Transform parent, string name, Vector2 pos, Vector2 size, int optionIndex, bool clickActs = false)
        {
            ...
            AddTrigger(trigger, EventTriggerType.PointerClick, (_) =>
            {
                ...
                if (clickActs)
                {
                    if (optionIndex == 2 || optionIndex == 3 || optionIndex == 4 || optionIndex == 6)
                        AdjustSelectedSetting(0.05f);
                    else if (optionIndex == 5 || optionIndex == 7 || optionIndex == 8 || optionIndex == 10)
                        ActivateSelectedSetting();
