...
{
    /// <summary>
    /// Avance 96 – correccion Android del HUD tactil.
    ///
    ...
    /// para D/F/J/K, evitando que EventTrigger/StandaloneInputModule pierda toques
    /// simultaneos. La pausa movil ya no abre el panel de pausa de escritorio:
    /// usa un overlay tactil simple para evitar el panel morado y estados bloqueados.
    /// </summary>
    ...
    public sealed class MobileTouchControls : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (gameController == null || lanes == null || lanes.Length == 0)
                RefreshSceneReferences();
        ...
        private void BuildHud()
        {
            ...
            laneButtonRects[0] = CreateLaneButton(controls.transform, "PB_Touch_D", "D", 0, new Vector2(210f, 142f), TextAnchor.LowerLeft);
            laneButtonRects[1] = CreateLaneButton(controls.transform, "PB_Touch_F", "F", 1, new Vector2(360f, 142f), TextAnchor.LowerLeft);
            laneButtonRects[2] = CreateLaneButton(controls.transform, "PB_Touch_J", "J", 2, new Vector2(-360f, 142f), TextAnchor.LowerRight);
            laneButtonRects[3] = CreateLaneButton(controls.transform, "PB_Touch_K", "K", 3, new Vector2(-210f, 142f), TextAnchor.LowerRight);
        ...
        private void PollAndroidTouches()
        {
            ...
            for (int i = 0; i < Input.touchCount; i++)
            {
                ...
                if (touch.phase == TouchPhase.Began && ContainsScreenPoint(pauseButtonRect, pos))
