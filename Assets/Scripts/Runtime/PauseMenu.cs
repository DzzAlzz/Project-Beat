...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private static readonly string[] OptionNames = { "CONTINUAR", "ELEGIR NIVEL", "REINICIAR", "SALIR" };
        private static readonly string[] OptionIcons = { "PLAY", "LEVEL", "RETRY", "QUIT" };
        ...
        {
            TMP_Text[] allTexts = { resumeLabel, selectLevelLabel, restartLabel, quitLabel, levelNameText, levelArtistText, levelHintText };
        ...
        private void BuildCommercialPauseMenu()
        {
            ...
            {
                RectTransform button = CreateButtonShell(pauseGroup.transform, "PB_UI_MenuButton_" + i, new Vector2(0f, startY - i * 78f), 9 + i);
            ...
            CreateTmp(pauseGroup.transform, "PB_UI_PauseHint", "<color=#00F1FF>[↑/↓]</color> Navegar     <color=#FFF000>[ENTER]</color> Confirmar     <color=#FF6A00>[ESC]</color> Cerrar", new Vector2(0f, -238f), new Vector2(540f, 28f), 17f, TextNormal, 20, FontStyles.Normal, 1.5f);
            RefreshLabels();
        }
