...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private void BuildSettingsPanel()
        {
            ...
            // Avance 70: configuracion retocada para coincidir con la estetica morada/neon
            // del menu principal, Como Jugar y Creditos, sin tocar la logica de opciones.
            CreateFullScreenImage(groupGO.transform, "PB_Settings_Dim", new Color(0.010f, 0.000f, 0.045f, 0.58f), 0);
            CreateFloatingGlow(groupGO.transform, "PB_Settings_Glow_Magenta", new Vector2(-380f, 230f), new Vector2(760f, 170f), new Color(1f, 0.12f, 0.75f, 0.16f), 1);
            CreateFloatingGlow(groupGO.transform, "PB_Settings_Glow_Cyan", new Vector2(430f, -260f), new Vector2(720f, 150f), new Color(0f, 0.92f, 1f, 0.12f), 2);
            RectTransform settingsCard = CreateCard(groupGO.transform, "PB_Settings_Card", new Vector2(1500f, 900f), Vector2.zero, 3);
            Image settingsCardImage = settingsCard != null ? settingsCard.GetComponent<Image>() : null;
            if (settingsCardImage != null)
                settingsCardImage.color = new Color(0.055f, 0.015f, 0.105f, 0.96f);
            CreateLine(groupGO.transform, "PB_Settings_TopLine", new Vector2(0f, 425f), new Vector2(1260f, 4f), NeonCyan, 4);
            CreateLine(groupGO.transform, "PB_Settings_BottomLine", new Vector2(0f, -420f), new Vector2(760f, 3f), new Color(1f, 0.14f, 0.82f, 1f), 5);
            CreateLine(groupGO.transform, "PB_Settings_TitleAccent", new Vector2(0f, 338f), new Vector2(690f, 2f), new Color(1f, 0.14f, 0.82f, 0.58f), 6);

            settingsTitleText = CreateTmp(groupGO.transform, "PB_Settings_Title", "CONFIGURACION", new Vector2(0f, 374f), new Vector2(900f, 62f), 44f, new Color(1f, 0.88f, 1f, 1f), 7, FontStyles.Bold, 5f);
            ...
            CreateLine(groupGO.transform, "PB_Settings_Separator_Top", new Vector2(0f, 258f), new Vector2(1180f, 2f), new Color(1f, 0.14f, 0.82f, 0.22f), 17);
            CreateLine(groupGO.transform, "PB_Settings_Separator_Mid", new Vector2(0f, -130f), new Vector2(1180f, 2f), new Color(0f, 0.92f, 1f, 0.18f), 18);
            CreateLine(groupGO.transform, "PB_Settings_Separator_Bottom", new Vector2(0f, -282f), new Vector2(1180f, 2f), new Color(1f, 0.14f, 0.82f, 0.22f), 19);
        ...
        private void RefreshSettingsPanel()
        {
            ...
            settingsHintText.text = "<color=#00F1FF>[W/S]</color> Seleccionar    <color=#FF37D6>[A/D]</color> Ajustar / Cambiar    <color=#FFF000>[ESC]</color> Volver    <color=#D7B6FF>[MOUSE]</color> Click / Arrastrar";
        }
