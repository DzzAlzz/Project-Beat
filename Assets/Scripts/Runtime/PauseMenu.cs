...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private const float SettingsScrollMax = 330f;
        ...
        private void BuildSettingsPanel()
        {
            ...
            // Avance 88: panel de configuración más amplio, limpio y con scroll vertical.
            ...
            CreateLine(groupGO.transform, "PB_Settings_TopLine", new Vector2(0f, 445f), new Vector2(1320f, 4f), NeonCyan, 4);
            ...
            viewportRT.anchoredPosition = new Vector2(-10f, -10f);
            viewportRT.sizeDelta = new Vector2(1450f, 650f);
            ...
            settingsScrollContent.sizeDelta = new Vector2(1420f, 980f);
            ...
            controlsHeaderText = CreateTmp(content, "PB_Settings_ControlsHeader", "", new Vector2(-395f, 300f), new Vector2(700f, 34f), 23f, NeonCyan, 6, FontStyles.Bold, 2f);
            controlsDescriptionText = CreateTmp(content, "PB_Settings_ControlsDescription", "", new Vector2(-386f, 270f), new Vector2(780f, 30f), 15f, TextDim, 7, FontStyles.Normal, 0f);
            graphicsHeaderText = CreateTmp(content, "PB_Settings_GraphicsHeader", "", new Vector2(-395f, 215f), new Vector2(700f, 36f), 24f, NeonCyan, 8, FontStyles.Bold, 2f);
            brightnessLabelText = CreateTmp(content, "PB_Settings_BrightnessLabel", "", new Vector2(-395f, 154f), new Vector2(700f, 52f), 19f, TextNormal, 9, FontStyles.Normal, 0f);
            resolutionLabelText = CreateTmp(content, "PB_Settings_ResolutionLabel", "", new Vector2(-395f, 88f), new Vector2(700f, 52f), 19f, TextNormal, 10, FontStyles.Normal, 0f);
            displayModeLabelText = CreateTmp(content, "PB_Settings_DisplayModeLabel", "", new Vector2(-395f, 22f), new Vector2(700f, 52f), 19f, TextNormal, 11, FontStyles.Normal, 0f);
            effectsLabelText = CreateTmp(content, "PB_Settings_EffectsLabel", "", new Vector2(-395f, -44f), new Vector2(740f, 52f), 19f, TextNormal, 12, FontStyles.Normal, 0f);
            sensitivityLabelText = CreateTmp(content, "PB_Settings_SensitivityLabel", "", new Vector2(-395f, -110f), new Vector2(740f, 52f), 19f, TextNormal, 13, FontStyles.Normal, 0f);
            visualQualityLabelText = CreateTmp(content, "PB_Settings_VisualQualityLabel", "", new Vector2(-395f, -176f), new Vector2(740f, 52f), 19f, TextNormal, 14, FontStyles.Normal, 0f);
            comboEffectsLabelText = CreateTmp(content, "PB_Settings_ComboEffectsLabel", "", new Vector2(-395f, -242f), new Vector2(740f, 52f), 19f, TextNormal, 15, FontStyles.Normal, 0f);
            comboAuraLabelText = CreateTmp(content, "PB_Settings_ComboAuraLabel", "", new Vector2(-395f, -308f), new Vector2(740f, 52f), 19f, TextNormal, 16, FontStyles.Normal, 0f);
            soundHeaderText = CreateTmp(content, "PB_Settings_SoundHeader", "", new Vector2(-395f, -388f), new Vector2(700f, 36f), 24f, NeonCyan, 17, FontStyles.Bold, 2f);
            volumeLabelText = CreateTmp(content, "PB_Settings_VolumeLabel", "", new Vector2(-395f, -450f), new Vector2(700f, 52f), 19f, TextNormal, 18, FontStyles.Normal, 0f);
            generalHeaderText = CreateTmp(content, "PB_Settings_GeneralHeader", "", new Vector2(-395f, -530f), new Vector2(700f, 36f), 24f, NeonCyan, 19, FontStyles.Bold, 2f);
            resetValuesText = CreateTmp(content, "PB_Settings_ResetValues", "", new Vector2(-395f, -592f), new Vector2(740f, 52f), 21f, TextNormal, 20, FontStyles.Bold, 1.0f);
            settingsBackText = CreateTmp(content, "PB_Settings_Back", "", new Vector2(-395f, -660f), new Vector2(700f, 50f), 24f, NeonOrange, 21, FontStyles.Bold, 1.5f);
            ...
            CreateLine(content, "PB_Settings_Separator_Top", new Vector2(0f, 238f), new Vector2(1260f, 2f), new Color(1f, 0.14f, 0.82f, 0.22f), 22);
            CreateLine(content, "PB_Settings_Separator_Mid", new Vector2(0f, -350f), new Vector2(1260f, 2f), new Color(0f, 0.92f, 1f, 0.18f), 23);
            CreateLine(content, "PB_Settings_Separator_Bottom", new Vector2(0f, -500f), new Vector2(1260f, 2f), new Color(1f, 0.14f, 0.82f, 0.22f), 24);

            CreateSliderVisual(content, "PB_Settings_BrightnessSlider", new Vector2(295f, 154f), out brightnessSliderFill, out brightnessSliderGlow, out brightnessSliderHandle);
            brightnessValueText = CreateTmp(content, "PB_Settings_BrightnessValue", "100%", new Vector2(690f, 154f), new Vector2(230f, 34f), 22f, NeonYellow, 25, FontStyles.Bold, 1.0f);
            brightnessValueText.alignment = TextAlignmentOptions.Right;

            resolutionValueText = CreateTmp(content, "PB_Settings_ResolutionValue", "1920x1080", new Vector2(660f, 88f), new Vector2(330f, 34f), 22f, NeonYellow, 26, FontStyles.Bold, 1.0f);
            resolutionValueText.alignment = TextAlignmentOptions.Right;

            displayModeValueText = CreateTmp(content, "PB_Settings_DisplayModeValue", "PANTALLA COMPLETA", new Vector2(625f, 22f), new Vector2(470f, 34f), 21f, NeonYellow, 27, FontStyles.Bold, 0.5f);
            displayModeValueText.alignment = TextAlignmentOptions.Right;

            CreateSliderVisual(content, "PB_Settings_EffectsSlider", new Vector2(295f, -44f), out effectsSliderFill, out effectsSliderGlow, out effectsSliderHandle);
            effectsValueText = CreateTmp(content, "PB_Settings_EffectsValue", "MEDIO", new Vector2(690f, -44f), new Vector2(230f, 34f), 22f, NeonYellow, 28, FontStyles.Bold, 1.0f);
            effectsValueText.alignment = TextAlignmentOptions.Right;

            sensitivityValueText = CreateTmp(content, "PB_Settings_SensitivityValue", "OFF", new Vector2(690f, -110f), new Vector2(230f, 34f), 22f, NeonYellow, 29, FontStyles.Bold, 1.0f);
            sensitivityValueText.alignment = TextAlignmentOptions.Right;

            visualQualityValueText = CreateTmp(content, "PB_Settings_VisualQualityValue", "ALTA", new Vector2(690f, -176f), new Vector2(230f, 34f), 22f, NeonYellow, 30, FontStyles.Bold, 1.0f);
            visualQualityValueText.alignment = TextAlignmentOptions.Right;

            comboEffectsValueText = CreateTmp(content, "PB_Settings_ComboEffectsValue", "ON", new Vector2(690f, -242f), new Vector2(230f, 34f), 22f, NeonYellow, 31, FontStyles.Bold, 1.0f);
            comboEffectsValueText.alignment = TextAlignmentOptions.Right;

            comboAuraValueText = CreateTmp(content, "PB_Settings_ComboAuraValue", "ON", new Vector2(690f, -308f), new Vector2(230f, 34f), 22f, NeonYellow, 32, FontStyles.Bold, 1.0f);
            comboAuraValueText.alignment = TextAlignmentOptions.Right;

            CreateSliderVisual(content, "PB_Settings_VolumeSlider", new Vector2(295f, -450f), out volumeSliderFill, out volumeSliderGlow, out volumeSliderHandle);
            volumeValueText = CreateTmp(content, "PB_Settings_VolumeValue", "100%", new Vector2(690f, -450f), new Vector2(230f, 34f), 22f, NeonYellow, 33, FontStyles.Bold, 1.0f);
            ...
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Controls", new Vector2(-395f, 285f), new Vector2(850f, 62f), 0);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_BrightnessRow", new Vector2(-395f, 154f), new Vector2(850f, 58f), 1);
            AddSettingsSliderMouseZone(content, "PB_Settings_Mouse_BrightnessSlider", new Vector2(295f, 154f), new Vector2(590f, 48f), 1);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Resolution", new Vector2(-395f, 88f), new Vector2(850f, 58f), 2, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_DisplayMode", new Vector2(-395f, 22f), new Vector2(850f, 58f), 3, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_EffectsRow", new Vector2(-395f, -44f), new Vector2(850f, 58f), 4);
            AddSettingsSliderMouseZone(content, "PB_Settings_Mouse_EffectsSlider", new Vector2(295f, -44f), new Vector2(590f, 48f), 4);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Sensitivity", new Vector2(-395f, -110f), new Vector2(850f, 58f), 5, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_VisualQuality", new Vector2(-395f, -176f), new Vector2(850f, 58f), 6, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_ComboEffects", new Vector2(-395f, -242f), new Vector2(850f, 58f), 7, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_ComboAura", new Vector2(-395f, -308f), new Vector2(850f, 58f), 8, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_VolumeRow", new Vector2(-395f, -450f), new Vector2(850f, 58f), 9);
            AddSettingsSliderMouseZone(content, "PB_Settings_Mouse_VolumeSlider", new Vector2(295f, -450f), new Vector2(590f, 48f), 9);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Reset", new Vector2(-395f, -592f), new Vector2(850f, 58f), 10, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Back", new Vector2(-395f, -660f), new Vector2(850f, 58f), 11, true);
        ...
        private void CreateSettingsScrollbar(Transform parent)
        {
            ...
            trackRT.anchoredPosition = new Vector2(735f, -10f);
            trackRT.sizeDelta = new Vector2(18f, 650f);
        ...
        private void ApplySettingsScrollLayout()
        {
            ...
            if (settingsScrollHandle != null)
            {
                ...
                float trackHeight = 650f;
                float handleHeight = 170f;
        ...
        private void AddSettingsMouseZone(Transform parent, string name, Vector2 pos, Vector2 size, int optionIndex, bool clickActs = false)
        {
            ...
            AddTrigger(trigger, EventTriggerType.PointerClick, (_) =>
            {
                ...
                if (clickActs)
                {
                    if (optionIndex == 2 || optionIndex == 3 || optionIndex == 6)
                        AdjustSelectedSetting(0.05f);
