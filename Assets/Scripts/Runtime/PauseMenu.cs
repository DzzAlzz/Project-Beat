...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        {
            // Avance 39: volver al menu principal debe limpiar por completo
            // el estado del nivel actual. Recargar la escena con SkipStartup en 0
            // evita que el nivel anterior siga sonando o activo detras del menu.
            Time.timeScale = 1f;
