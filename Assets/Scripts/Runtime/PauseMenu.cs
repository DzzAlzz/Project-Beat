...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        {
            // Avance 40: regresar al menu principal debe cargar el flujo inicial
            // real del juego, no solo cerrar la pausa. Antes de recargar se limpia
            // el estado de gameplay para evitar musica, notas o particulas residuales.
            Time.timeScale = 1f;

            CleanupGameplayBeforeMainMenu();

            PlayerPrefs.SetInt(StartupFlowController.SkipStartupPrefsKey, 0);
            PlayerPrefs.Save();
