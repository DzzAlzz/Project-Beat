...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private void BuildSettingsPanel()
        {
            ...
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Controls", new Vector2(-330f, 285f), new Vector2(920f, 62f), 0);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_BrightnessRow", new Vector2(-330f, 154f), new Vector2(920f, 58f), 1);
            AddSettingsSliderMouseZone(content, "PB_Settings_Mouse_BrightnessSlider", new Vector2(270f, 154f), new Vector2(520f, 48f), 1);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Resolution", new Vector2(-330f, 88f), new Vector2(920f, 58f), 2, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_DisplayMode", new Vector2(-330f, 22f), new Vector2(920f, 58f), 3, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_EffectsRow", new Vector2(-330f, -44f), new Vector2(920f, 58f), 4);
            AddSettingsSliderMouseZone(content, "PB_Settings_Mouse_EffectsSlider", new Vector2(270f, -44f), new Vector2(520f, 48f), 4);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Sensitivity", new Vector2(-330f, -110f), new Vector2(920f, 58f), 5, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_VisualQuality", new Vector2(-330f, -176f), new Vector2(920f, 58f), 6, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_ComboEffects", new Vector2(-330f, -242f), new Vector2(920f, 58f), 7, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_ComboAura", new Vector2(-330f, -308f), new Vector2(920f, 58f), 8, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_VolumeRow", new Vector2(-330f, -450f), new Vector2(920f, 58f), 9);
            AddSettingsSliderMouseZone(content, "PB_Settings_Mouse_VolumeSlider", new Vector2(270f, -450f), new Vector2(520f, 48f), 9);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Reset", new Vector2(-330f, -592f), new Vector2(920f, 58f), 10, true);
            AddSettingsMouseZone(content, "PB_Settings_Mouse_Back", new Vector2(-330f, -660f), new Vector2(920f, 58f), 11, true);
