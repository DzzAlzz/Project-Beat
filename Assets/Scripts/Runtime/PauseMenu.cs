...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private static readonly string[] OptionNames = { "CONTINUAR", "ELEGIR NIVEL", "REINICIAR", "CONFIGURACION", "SALIR" };
        private static readonly string[] OptionIcons = { "PLAY", "LEVEL", "RETRY", "SETUP", "QUIT" };
