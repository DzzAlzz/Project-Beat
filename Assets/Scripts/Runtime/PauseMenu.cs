...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private void BuildSettingsPanel()
        {
            ...
            CreateCard(groupGO.transform, "PB_Settings_Card", new Vector2(900f, 820f), Vector2.zero, 1);
            CreateLine(groupGO.transform, "PB_Settings_TopLine", new Vector2(0f, 395f), new Vector2(680f, 4f), NeonCyan, 2);
            CreateLine(groupGO.transform, "PB_Settings_BottomLine", new Vector2(0f, -392f), new Vector2(470f, 3f), NeonOrange, 3);

            settingsTitleText = CreateTmp(groupGO.transform, "PB_Settings_Title", "CONFIGURACION", new Vector2(0f, 350f), new Vector2(720f, 52f), 34f, NeonYellow, 4, FontStyles.Bold, 5f);
            ...
            controlsHeaderText = CreateTmp(groupGO.transform, "PB_Settings_ControlsHeader", "", new Vector2(-335f, 294f), new Vector2(330f, 26f), 18f, NeonCyan, 6, FontStyles.Bold, 2f);
            controlsDescriptionText = CreateTmp(groupGO.transform, "PB_Settings_ControlsDescription", "", new Vector2(-330f, 270f), new Vector2(460f, 24f), 13f, TextDim, 7, FontStyles.Normal, 0f);
            graphicsHeaderText = CreateTmp(groupGO.transform, "PB_Settings_GraphicsHeader", "", new Vector2(-335f, 226f), new Vector2(330f, 28f), 19f, NeonCyan, 8, FontStyles.Bold, 2f);
            brightnessLabelText = CreateTmp(groupGO.transform, "PB_Settings_BrightnessLabel", "", new Vector2(-315f, 184f), new Vector2(360f, 38f), 16f, TextNormal, 9, FontStyles.Normal, 0f);
            resolutionLabelText = CreateTmp(groupGO.transform, "PB_Settings_ResolutionLabel", "", new Vector2(-315f, 118f), new Vector2(360f, 38f), 16f, TextNormal, 10, FontStyles.Normal, 0f);
            displayModeLabelText = CreateTmp(groupGO.transform, "PB_Settings_DisplayModeLabel", "", new Vector2(-315f, 62f), new Vector2(360f, 38f), 16f, TextNormal, 11, FontStyles.Normal, 0f);
            effectsLabelText = CreateTmp(groupGO.transform, "PB_Settings_EffectsLabel", "", new Vector2(-315f, 1f), new Vector2(420f, 42f), 16f, TextNormal, 12, FontStyles.Normal, 0f);
            sensitivityLabelText = CreateTmp(groupGO.transform, "PB_Settings_SensitivityLabel", "", new Vector2(-315f, -78f), new Vector2(420f, 42f), 16f, TextNormal, 13, FontStyles.Normal, 0f);
            soundHeaderText = CreateTmp(groupGO.transform, "PB_Settings_SoundHeader", "", new Vector2(-335f, -168f), new Vector2(330f, 28f), 19f, NeonCyan, 14, FontStyles.Bold, 2f);
            volumeLabelText = CreateTmp(groupGO.transform, "PB_Settings_VolumeLabel", "", new Vector2(-315f, -211f), new Vector2(360f, 38f), 16f, TextNormal, 15, FontStyles.Normal, 0f);
            settingsBackText = CreateTmp(groupGO.transform, "PB_Settings_Back", "", new Vector2(-315f, -302f), new Vector2(360f, 42f), 20f, NeonOrange, 16, FontStyles.Bold, 1.5f);
            ...
            CreateLine(groupGO.transform, "PB_Settings_Separator_Top", new Vector2(-70f, 250f), new Vector2(620f, 2f), new Color(0f, 0.92f, 1f, 0.16f), 17);
            CreateLine(groupGO.transform, "PB_Settings_Separator_Mid", new Vector2(-70f, -135f), new Vector2(620f, 2f), new Color(0f, 0.92f, 1f, 0.16f), 18);
            CreateLine(groupGO.transform, "PB_Settings_Separator_Bottom", new Vector2(-70f, -257f), new Vector2(620f, 2f), new Color(0f, 0.92f, 1f, 0.16f), 19);

            CreateSliderVisual(groupGO.transform, "PB_Settings_BrightnessSlider", new Vector2(130f, 184f), out brightnessSliderFill, out brightnessSliderGlow, out brightnessSliderHandle);
            brightnessValueText = CreateTmp(groupGO.transform, "PB_Settings_BrightnessValue", "100%", new Vector2(360f, 184f), new Vector2(150f, 28f), 18f, NeonYellow, 20, FontStyles.Bold, 1.0f);
            brightnessValueText.alignment = TextAlignmentOptions.Right;

            resolutionValueText = CreateTmp(groupGO.transform, "PB_Settings_ResolutionValue", "1920x1080", new Vector2(320f, 118f), new Vector2(230f, 32f), 18f, NeonYellow, 21, FontStyles.Bold, 1.0f);
            resolutionValueText.alignment = TextAlignmentOptions.Right;

            displayModeValueText = CreateTmp(groupGO.transform, "PB_Settings_DisplayModeValue", "PANTALLA COMPLETA", new Vector2(290f, 62f), new Vector2(290f, 32f), 18f, NeonYellow, 22, FontStyles.Bold, 0.5f);
            displayModeValueText.alignment = TextAlignmentOptions.Right;

            CreateSliderVisual(groupGO.transform, "PB_Settings_EffectsSlider", new Vector2(130f, 1f), out effectsSliderFill, out effectsSliderGlow, out effectsSliderHandle);
            effectsValueText = CreateTmp(groupGO.transform, "PB_Settings_EffectsValue", "MEDIO", new Vector2(360f, 1f), new Vector2(150f, 28f), 18f, NeonYellow, 23, FontStyles.Bold, 1.0f);
            effectsValueText.alignment = TextAlignmentOptions.Right;

            sensitivityValueText = CreateTmp(groupGO.transform, "PB_Settings_SensitivityValue", "OFF", new Vector2(360f, -78f), new Vector2(150f, 28f), 18f, NeonYellow, 24, FontStyles.Bold, 1.0f);
            sensitivityValueText.alignment = TextAlignmentOptions.Right;

            CreateSliderVisual(groupGO.transform, "PB_Settings_VolumeSlider", new Vector2(130f, -211f), out volumeSliderFill, out volumeSliderGlow, out volumeSliderHandle);
            volumeValueText = CreateTmp(groupGO.transform, "PB_Settings_VolumeValue", "100%", new Vector2(360f, -211f), new Vector2(150f, 28f), 18f, NeonYellow, 25, FontStyles.Bold, 1.0f);
            volumeValueText.alignment = TextAlignmentOptions.Right;

            settingsHintText = CreateTmp(groupGO.transform, "PB_Settings_Hint", "", new Vector2(0f, -360f), new Vector2(780f, 42f), 15f, TextDim, 26, FontStyles.Normal, 1.0f);
