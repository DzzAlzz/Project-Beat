...
namespace ProjectBeat.Runtime
{
    ...
    public class PauseMenu : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            if (!isResumeCountdown || string.IsNullOrEmpty(resumeCountdownLabel)) return;
            ...
            style.normal.textColor = resumeCountdownLabel == "GO"
                ? new Color(0.0f, 0.95f, 1f, 1f)
                : new Color(1f, 0.94f, 0.04f, 1f);
