...
namespace ProjectBeat.Runtime
{
    ...
    public class StartupFlowController : MonoBehaviour
    {
        ...
        private void BuildUI()
        {
            ...
            panel.rectTransform.sizeDelta = new Vector2(560f, 390f);
            ...
            label.rectTransform.anchoredPosition = new Vector2(0f, 78f);
            label.rectTransform.sizeDelta = new Vector2(520f, 38f);

            arcadeButton = CreateModeButton(menuGroup.transform, "ArcadeButton", new Vector2(0f, 18f), true, out arcadeBg, out arcadeLabel);
            futureButton = CreateModeButton(menuGroup.transform, "FutureButton", new Vector2(0f, -72f), false, out futureBg, out futureLabel);

            TMP_Text hint = CreateText("Hint", menuGroup.transform, "[W/S] Navegar     [ENTER] Confirmar", 14, TextDim, FontStyles.Bold);
            hint.alignment = TextAlignmentOptions.Center;
            hint.rectTransform.anchoredPosition = new Vector2(0f, -150f);
            hint.rectTransform.sizeDelta = new Vector2(520f, 32f);
        }

        private RectTransform CreateModeButton(Transform parent, string name, Vector2 pos, bool available, out Image bg, out TMP_Text label)
        {
            ...
            string text = available ? "ARCADE" : "PROXIMAMENTE";
            string sub = available ? "Selector de niveles" : "Nuevo modo futuro";
        ...
        {
            AnimateButton(arcadeButton, arcadeBg, arcadeLabel, selectedIndex == 0, true);
            AnimateButton(futureButton, futureBg, futureLabel, selectedIndex == 1, false);
        }
